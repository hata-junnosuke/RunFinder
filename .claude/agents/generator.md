...
## 技術スタック
Next.js (App Router) / Hono on Bun / Drizzle ORM / PostgreSQL / Google Maps API / Docker Compose

## コマンド実行ルール
すべてのコマンドは必ずDockerコンテナ内で実行する。
- API: `docker compose exec api bun test`
- Web: `docker compose exec web npm run lint`
